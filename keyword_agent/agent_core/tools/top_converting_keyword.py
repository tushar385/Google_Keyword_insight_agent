...
@tool
def top_converting_keyword(vertical_sector: str) -> list:
    """Returns top 5 performing keywords by conversions for a given industry vertical sector."""
